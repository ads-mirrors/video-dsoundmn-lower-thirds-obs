function preview() {
	...
	document.getElementsByTagName('iframe')[0].src = 'http://localhost:8040' + url;
	document.getElementById('url').innerHTML = 'http://localhost:8040' + url;
	document.getElementById('hiddenURL').value = 'http://localhost:8040' + url;
}
